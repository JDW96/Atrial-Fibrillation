...
for i in range(10**6):
    ...
    ### Create seperate arrays using np.where for dysfunctional and non dysfunctional cells that need to be excited
    ### Create np.random array of length dysfunctional and check if they excite that way
