...
#A = AC2.Atrium(hexagonal = False, v_para=0.6,v_tran_1= 0.6,v_tran_2= 0.4, threshold = 2, e = 0.05, seed1=1520, seed2=250, seed3=230,seed4 = 204)
A = AC3.Atrium(hexagonal = False, v_para=0.6,v_tran_1= 0.6,v_tran_2= 0.4, threshold = 0.25, seed1=1520, seed2=250, seed3=230)
